...
Klone dieses Repository in dein WorkBuddy-Skills-Verzeichnis:
...
Oder kopiere den Ordner manuell nach `~/.workbuddy/skills/`.

## Voraussetzungen

- Die Eagle-Desktop-App muss laufen.
- `eagle-mcp` muss in `~/.workbuddy/mcp.json` konfiguriert und im Connector-Panel vertrauenswürdig sein.
